...
cadastroController.setAttribute("src", "../js/controller/cadastroController.js");

cadastroView.setAttribute("type", "module");
cadastroView.setAttribute("src", "../js/view/cadastroView.js");

enderecoController.setAttribute("type", "module");
enderecoController.setAttribute("src", "../js/controller/enderecoController.js");

enderecoView.setAttribute("type", "module");
enderecoView.setAttribute("src", "../js/view/enderecoView.js");
